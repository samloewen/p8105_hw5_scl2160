...
yi=β0+β1xi1+ϵi
with ϵi∼N[0,σ2]. For each dataset, save β^1 and the p-value arising from a test of H:β1=0 using α=0.05. Hint: to obtain the estimate and p-value, use broom::tidy to clean the output of lm.
